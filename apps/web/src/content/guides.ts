...
export const energyGuides: Record<string, GuideDefinition> = {
  ...
  'how-much-electricity-does-an-electric-kettle-use': {
    ...
    title: 'Electric Kettle Power Consumption: kWh and Cost',
    h1Title: 'How Much Electricity Does an Electric Kettle Use?',
    breadcrumbLabel: 'Electric Kettle Electricity Cost',
    description:
      'A 1,200W electric kettle running for 5 minutes uses 0.1 kWh of electricity ($0.018 per boil at 18.44¢/kWh). Formula: (Watts × Hours ÷ 1,000) × Rate.',
    ...
    summaryTakeaways: [
      'A 1,200-watt electric kettle running for 5 minutes consumes exactly 0.10 kWh of electricity.',
      'Boiling 1 liter of water costs approximately $0.018 to $0.023 per boil at the U.S. national average electricity rate (18.44¢/kWh).',
      'Overfilling an electric kettle by heating 1.7L when needing only 250mL for one cup of tea wastes up to 80% of the energy consumed during that boil session.',
    ],
    sections: [],
    sources: [
      {
