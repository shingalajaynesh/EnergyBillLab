...
export const august2026ElectricDehumidifierKwhOperatingCostBenchmark: InsightRecord = {
  id: 'august-2026-electric-dehumidifier-kwh-operating-cost-benchmark',
  slug: 'august-2026-electric-dehumidifier-kwh-operating-cost-benchmark',
  title:
    'August 2026 Electric Dehumidifier kWh Consumption & Humidity Control Operating Cost Benchmark',
  metaTitle:
    'August 2026 Dehumidifier Electricity Cost & Energy Star Benchmark | EnergyBillLab',
  metaDescription:
  ...
  intentFingerprint: 'electric-dehumidifier-kwh-humidity-control-operating-cost-benchmark',
  primaryIntent:
    'Quantify August 2026 portable electric dehumidifier kWh electricity consumption, daily and monthly operating costs, capacity size benchmarks (30-pint, 50-pint, 70-pint), ENERGY STAR vs. standard efficiency savings, humidistat duty cycle scenarios (12-hour moderate vs. 24-hour continuous), and state-by-state monthly cost spreads using May 2026 EIA electricity rates.',
  primaryQuery: 'dehumidifier electricity cost per month august 2026',
  secondaryQueries: [
  ...
  sections: [
    {
      heading: 'Dehumidifier Power Consumption & Capacity Size Benchmark',
      paragraphs: [
    ...
    {
      heading: 'Humidistat Duty Cycle Scenarios: 12-Hour Cycling vs. 24/7 Continuous Operation',
      paragraphs: [
    ...
    {
      heading: 'State-by-State Monthly Dehumidifier Operating Cost Matrix',
      paragraphs: [
    ...
    {
      heading: 'Practical Actionable Steps to Reduce Dehumidifier Operating Costs',
      paragraphs: [
  ...
  sources: [
    ...
    },
    {
      ...
      title: '10 CFR Part 430 — Energy Conservation Program: Test Procedures for Dehumidifiers',
      url: 'https://www.energy.gov/eere/buildings/appliance-and-equipment-standards-program',
      topic:
        'Dehumidifier capacity rating standards (pints/24hr), Integrated Energy Factor (IEF) test protocols, and energy measurement',
    },
    {
      organization: 'ENERGY STAR Program',
      title: 'ENERGY STAR Product Specifications for Dehumidifiers (Version 5.1)',
      url: 'https://www.energystar.gov/products/appliances/dehumidifiers',
      topic:
        'ENERGY STAR IEF efficiency benchmarks (≥1.57 L/kWh portable ≤25 pt, ≥1.90 L/kWh portable >25-50 pt) and wattage savings',
    },
  ],
  relatedRoutes: [
