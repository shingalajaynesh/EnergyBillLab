...
export const august2026HomeApplianceOperatingCostHierarchyBenchmark: InsightRecord = {
  ...
  methodologyNotes:
    'EIA Form EIA-861M May 2026 residential rate dataset (released July 31, 2026). Standardized wattage & duty cycles: Central AC = 3,500W @ 50% duty cycle, 12h/day (630 kWh/mo); Electric Resistance Water Heater = 4,500W @ 3h/day (405 kWh/mo); EV Charger = 9,600W @ 1.25h/day (360 kWh/mo); Electric Dryer = 5,000W @ 1h/day (150 kWh/mo); Refrigerator = 150W avg @ 24h/day (108 kWh/mo); Portable Space Heater = 1,500W @ 6h/day (270 kWh/mo seasonal); Dishwasher = 1,200W @ 1h/day (36 kWh/mo); Whole-House LED Lighting = 135W @ 5h/day (20.25 kWh/mo); Television & Soundbar = 180W @ 4h/day (21.6 kWh/mo); Phantom Standby Load = 65W @ 24h/day (46.8 kWh/mo). Rates evaluated: 12.50¢, 18.44¢, 32.40¢/kWh.',
  sources: [
    {
