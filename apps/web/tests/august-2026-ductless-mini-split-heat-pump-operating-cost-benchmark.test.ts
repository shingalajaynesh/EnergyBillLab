...
import { august2026DuctlessMiniSplitHeatPumpOperatingCostBenchmark } from '../src/content/insights/articles/august-2026-ductless-mini-split-heat-pump-operating-cost-benchmark';
import {
...
describe('August 2026 Ductless Mini-Split Heat Pump Operating Cost Benchmark Insight', () => {
  ...
  it('5. adheres to strict author and privacy boundaries', () => {
    const record = august2026DuctlessMiniSplitHeatPumpOperatingCostBenchmark;
